...
import { addStageColumns } from "./enrichStage.js";
 ...
 *
 * 구조화·임베딩 스테이지 컬럼·인덱스는 enrichStage.ts의 addStageColumns가 담당한다 —
 * 의존 방향은 단방향이다(이 함수가 그쪽을 import하고, 그 반대는 없다).
 */
